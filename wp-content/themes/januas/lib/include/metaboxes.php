    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'name' => __('Start Date', 'januas'),

                'desc' => __('Insert the event start date', 'januas'),
            ...
            array(
                ...
                'name' => __('Start Time', 'januas'),

                'desc' => __('Insert the event start time (format: hh:mm, ex: 08:00)', 'januas'),
            ...
            array(
                ...
                'name' => __('End Date', 'januas'),

                'desc' => __('Insert the event end date', 'januas'),

                'id' => 'januas_eventdata_enddate',
            ...
            array(
                ...
                'name' => __('End Time', 'januas'),

                'desc' => __('Insert the event end time (format: hh:mm, ex: 08:00)', 'januas'),

                'id' => 'januas_eventdata_endtime',
