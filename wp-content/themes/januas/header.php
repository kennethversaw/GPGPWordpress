...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
    ...
    <head>
        ...
        <link href='<?php echo get_template_directory_uri(); ?>/lib/styles/style.css' rel='stylesheet' type='text/css'>
        ...
        if (!empty($theme_color))
            ...
            wp_enqueue_style('januas-theme-color', get_template_directory_uri() . "/lib/styles/colors/$theme_color.css");

		else
			
			wp_enqueue_style('januas-theme-color', get_template_directory_uri() . "/lib/styles/colors/default.css");
        ?>
    ...
    <body <?php body_class(); ?>>
        ...
        <a id="header_search" href="#">
            ...
            <img alt="<?php _e('Search button', 'januas'); ?>" src="<?php echo get_template_directory_uri(); ?>/lib/images/search_mobile.png" />

        </a>

        <a id="mobile_search" href="#">

            <img alt="<?php _e('Search', 'januas'); ?>" src="<?php echo get_template_directory_uri(); ?>/lib/images/open_close.png" />
