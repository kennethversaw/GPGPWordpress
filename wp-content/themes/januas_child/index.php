                    ...
                    <article id="post-<?php the_ID(); ?>" class="clearfix post <?php if ($i % 3 == 1) echo 'central'; ?> <?php echo $event_state; ?>" role="article"> 
                        ...
                        <header class="article-header">
                            ...
                            <p class="byline vcard"><?php _e('When:', 'januas'); ?> <time class="updated" datetime="<?php the_time('c'); ?>"><?php echo!empty($event_date) ? date_i18n(get_option('date_format'), get_post_meta($post->ID, 'januas_eventdata_startdate', true)) : ''; ?></time> 
                                <?php echo!empty($event_end_date) ? "- <time>" . date_i18n(get_option('date_format'), $event_end_date) . "</time>" : ''; ?>
                            </p>
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/lib/images/sold_out_<?php echo $home_layout . $theme_color; ?>.png" class="soldout overlay" alt="<?php _e('Sold Out', 'januas'); ?>" />

                        <img src="<?php echo get_template_directory_uri(); ?>/lib/images/ended_<?php echo $home_layout; ?>.png" class="ended overlay" alt="<?php _e('Ended', 'januas'); ?>" />
