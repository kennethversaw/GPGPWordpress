...
class Januas_Connect_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct('connect-widget', __('Januas Connect Widget', 'januas'), $widget_ops, $control_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        if (!empty($instance['email']))
            echo '<a href="mailto:' . $instance['email'] . '"><img src="' . get_template_directory_uri() . '/lib/images/mail.png" alt="Email" /></a> ';

        if (!empty($instance['rss']))
            echo '<a href="' . $instance['rss'] . '"><img src="' . get_template_directory_uri() . '/lib/images/rss.png" alt="RSS" /></a> ';

        if (!empty($instance['twitter']))
            echo '<a href="' . $instance['twitter'] . '"><img src="' . get_template_directory_uri() . '/lib/images/twitter.png" alt="Twitter" /></a> ';

        if (!empty($instance['facebook']))
            echo '<a href="' . $instance['facebook'] . '"><img src="' . get_template_directory_uri() . '/lib/images/facebook.png" alt="Facebook" /></a> ';

        if (!empty($instance['linkedin']))
            echo '<a href="' . $instance['linkedin'] . '"><img src="' . get_template_directory_uri() . '/lib/images/linkedin.png" alt="Linkedin" /></a> ';
