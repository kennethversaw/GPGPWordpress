...
function januas_register_settings() {
    ...
    add_settings_field('googlemaps-key', __('Google Maps API key', 'januas'), 'januas_settings_field_googlemaps_key', 'januas_theme_options', 'general');
...
function januas_settings_field_googlemaps_key() {

    $options = januas_get_theme_options();
    ?>

    <label><?php _e('Google Maps API key', 'januas'); ?>&nbsp;&nbsp;</label>

    <input type="text" name="januas_theme_options[googlemaps-key]" value="<?php echo!empty($options['googlemaps-key']) ? $options['googlemaps-key'] : ''; ?>" id="googlemaps-key" />
...
function januas_theme_options_validate($input) {
    ...
    $output['googlemaps-key'] = $input['googlemaps-key'];
...
function januas_customize_register($wp_customize) {
    ...
    $wp_customize->add_section('januas-googlemaps-key', array(
        'title'    => __('Google Maps API key', 'januas'),
        'priority' => 90,
    ));
    ...
    $wp_customize->add_setting('januas_theme_options[googlemaps-key]', array(
        'type'    => 'option',
        'default' => $defaults['googlemaps-key'],
    ));
    ...
    $wp_customize->add_control('januas_theme_options[googlemaps-key]', array(
        'section' => 'januas-googlemaps-key',
        'type'    => 'text',
        'label'   => __('Google Maps API key', 'januas')
    ));
}
