<footer class="footer" role="contentinfo">
    ...
    <?php if (!is_home()) { ?>
        ...
        <a id="back" href="#" onclick="history.back();return false;">
            ...
            <img alt="<?php _e('Search button', 'januas'); ?>" src="<?php echo get_template_directory_uri(); ?>/lib/images/arrow_back.png" />
    ...
    <?php if (is_singular('ja-event')) { ?>
        ...
        <a id="mobile_share" href="#social_container">
            ...
            <img alt="<?php _e('Search', 'januas'); ?>" src="<?php echo get_template_directory_uri(); ?>/lib/images/share_mobile.png" />
