...
class EF_Activation_License_Menu {
    ...
    public function add_menu() {
        ...
        add_menu_page(__('Showthemes', 'dxef'), __('Showthemes', 'dxef'), 'edit_theme_options', 'ef-options', array($this, 'theme_otherthemes_callback'), 'http://www.showthemes.com/ads/logo_mini.png');
        add_submenu_page('ef-options', __('More Themes', 'dxef'), __('More Themes', 'dxef'), 'edit_theme_options', 'ef-other-themes', array($this, 'theme_otherthemes_callback'));
    ...
    function theme_otherthemes_callback() {
        $current_theme = wp_get_theme();
        include_once( get_template_directory() . '/event-framework/inc/event-other-themes.php' );
    }
