...
wp_enqueue_style('jquery-ui-januas-theme', get_template_directory_uri() . '/lib/styles/blitzer/jquery-ui-1.9.2.custom.min.css');

wp_enqueue_script('januas-search-page', get_template_directory_uri() . '/lib/scripts/januas-search-page.js', array('jquery', 'jquery-ui'));
    ...
    <div id="inner-content" class="wrap clearfix">
        ...
        <div id="main" class="eightcol first clearfix" role="main">
            ...
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                    ...
                    $event_end_date = get_post_meta($post->ID, 'januas_eventdata_enddate', true);
                    ?>
                    ...
                    <article id="post-<?php the_ID(); ?>" class="clearfix post <?php echo $event_state; ?>" role="article"> 
                        ...
                        <header class="article-header">
                            ...
                            <p class="byline vcard">
                                <?php _e('When:', 'januas'); ?>
                                <time class="updated" datetime="<?php the_time(get_option('c')); ?>"><?php echo!empty($event_date) ? date_i18n($wp_date_format, get_post_meta($post->ID, 'januas_eventdata_startdate', true)) : ''; ?></time> 
                                <?php echo!empty($event_end_date) ? "- <time>" . date_i18n($wp_date_format, $event_end_date) . "</time>" : ''; ?>
                            </p>
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/lib/images/sold_out_three-columns<?php echo $theme_color; ?>.png" class="soldout overlay" alt="<?php _e('Sold Out', 'januas'); ?>" />

                        <img src="<?php echo get_template_directory_uri(); ?>/lib/images/ended_three-columns.png" class="ended overlay" alt="<?php _e('Ended', 'januas'); ?>" />
