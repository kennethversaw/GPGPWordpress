        ...
        function get_settings_email_fields() {
            ...
            $attendee_order_completed_email_fields = array(
                ...
                array(
                    ...
                    'field_description' => sprintf(__('Body of the e-mail. You can use following placeholders (%s)', 'tc'), apply_filters('tc_attendee_order_completed_message_placeholders_description', 'DOWNLOAD_URL, EVENT_NAME')),
                    'section' => 'attendee_order_completed_email',
                    'conditional' => array(
                        'field_name' => 'attendee_send_message',
                        'field_type' => 'radio',
