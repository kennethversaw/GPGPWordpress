	...
	<?php } else { ?>
		...
		<form action="" method="post" enctype = "multipart/form-data">
			...
			<div class="right-holder right-holder-second">
				...
				<?php } else { ?>
					<p><?php _e( 'NOTE: Save changes first, then check the preview.</br></br><strong>Important:</strong> Once done with creating a ticket template, make a test purhcase of a ticket that is using this template and test ticket scanning functionality prior going live with the ticket sales!', 'tc' ); ?></p>
