...
class tc_ticket_type_element extends TC_Ticket_Template_Elements {
	...
	function ticket_content( $ticket_instance_id = false, $ticket_type_id = false ) {
		if ( $ticket_instance_id ) {
			...
			return apply_filters( 'tc_ticket_type_element', apply_filters( 'tc_checkout_owner_info_ticket_title', $ticket->details->post_title, $ticket_instance->details->ticket_type_id, array(), $ticket_instance_id ) );
		} else {
			if ( $ticket_type_id ) {
