...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      $mb_premium_edition_label = "Premium Edition";
      ...
      $mb_upgrade_kanow_about = "Know about";
      $mb_full_features = "Full Features";
      $mb_chek_our = "or check our";
      $mb_online_demos = "Online Demos";
      ...
      $mb_limit_records_tooltip = __("Please choose Limit to view records", "wp-mail-bank");
      $mb_hundred_records = "100";
      $mb_five_hundred_records = "500";
      $mb_thousand_records = "1000";
      $mb_all_records = __("All", "wp-mail-bank");
      ...
      $mb_additional_header_tooltip = __("In this field, you would need to provide Custom Headers","wp-mail-bank");
      $mb_additional_header_placeholder = __("Please provide custom header","wp-mail-bank");
   }
}