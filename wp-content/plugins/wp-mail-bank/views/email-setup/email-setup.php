                        ...
                        <form id="ux_frm_email_configuration">
                           ...
                           <div id="ux_div_second_step" style="display:none">
                              ...
                              <div class="row">
                               ...
                               <div class="form-group">
                                   <label class="control-label">
                                    <?php echo $mb_additional_header; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $mb_additional_header_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true"> ( <?php echo $mb_premium_edition_label; ?> )</span>
                                 </label>
                                   <textarea class="form-control" id="ux_txt_additional_header" name="ux_txt_additional_header" disabled="disabled" placeholder="<?php echo $mb_additional_header_placeholder;?>"><?php echo isset($email_configuration_array["headers"]) ? esc_attr($email_configuration_array["headers"]) : "";?></textarea>
                               </div>
                              <div class="form-group">
                                 <label class="control-label">
                                 ...
                                 <select name="ux_ddl_type" id="ux_ddl_type" class="form-control" onchange="change_settings_mail_bank()">
                                    ...
                                    <option value="sendgrid_api" disabled="disabled" style="color:red;"><?php echo $mb_email_configuration_send_email_via_sendgrid_api; ?> ( <?php echo $mb_premium_edition_label; ?> )</option>
                                 </select>
                              </div>
